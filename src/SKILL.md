...
# Epistemic Deconstruction Protocol v7.16.4
...
| **0.7 Scope Interrogation** | STANDARD/COMPREHENSIVE/PSYCH only | `scope_auditor.py gate` PASS; ≥3 exogeneity candidates from M1-M4; `scope_audit.md` written | `phase-protocols.md#phase-0-7` | `scope-interrogation.md`, `archetype-accomplices.md`, `warning-reception.md` |
